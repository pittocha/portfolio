...
function Projects () {
    ...
    const projects = [
        ...
        },
        {
            ...
            image: KasaCard,
            description:"Configurer ls navigation avec React Router, Développer les éléments du site avec des composants React. Sur ce projet la plus grosse difficultée etait l'apprentissage de SASS et tout particliérement des animations et de l'utilisation de fonctions. ",
